    ...
    */
    public class Magpie4
    {
       ...
       public String getResponse(String statement)
       {
          ...
          else if (findKeyword(statement, "I want a car", 0) >= 0)
          {
       ...
       {
          // ADD CODE HERE
          return "Would you really be happy ...";
       }
     ...
     /**  ADD THIS
       ...
       private String transformIYouStatement(String statement)
       {
           ...
           int psn = findKeyword (statement, "I like you", 0);
           String restOfStatement = statement.substring(psn + 9).trim();
           return "Why do you like me " + restOfStatement + "?";
       }
