...
public class ShoppingListFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        ListenerRegistration = db.collection("shop").document(mShoppingList.docId).collection("usersShoppingList").whereEqualTo("ownerId", mAuth.getCurrentUser().getUid()).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                ...
                for (QueryDocumentSnapshot doc : value) {
                    ShoppingListItem shoppingList = doc.toObject(ShoppingListItem.class);
